					...
					<div class="row">
							...
							<div class="single-post row">
								...
								<div class="col-lg-3  col-md-3 meta-details">
									...
									<div class="user-details row">
										...
										<p class="view col-lg-12 col-md-12 col-6"><a href="#">{{post.counted_view}}</a> <span class="lnr lnr-eye"></span></p>
										<p class="comments col-lg-12 col-md-12 col-6"><a href="#">06 Commeeeents</a> <span class="lnr lnr-bubble"></span></p>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
										<div class="detials">
											{% if next_post %}
											<p>Next Post</p>
											<a href="{% url 'blog:single' next_postt.id %}"><h4>{{next_post.title}}</h4></a>
											{% endif %}
										</div>
										<div class="arrow">
						...
						<div class="col-lg-4 sidebar-widgets">
							<div class="widget-wrap">
								...
								{%include 'blog/blog-category.html' %}
